...
<body class="single-page">
	<div class="wrap-body">
		<div class="header">
			<div id='cssmenu' >
				<ul>
				   <li><a href='single1.php'><span>Home</span></a></li>
		...
		$user=$_SESSION['user1'];
		$pass=$_SESSION['pass1'];
		$pr=mysql_query("SELECT * from log where user='$user' and pass='$pass'");
    ...
    function ShowLoading(e) {
		...
		if(isset($_POST['up']))
		{
			if(empty($_FILES['img']['tmp_name'])){echo"select file!";}
					...
					$target="pic/".$pic;
					mysql_query("UPDATE log SET pic='$pic' WHERE user='$user'");
