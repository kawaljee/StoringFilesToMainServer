...
</br></br><input type="password" placeholder="Password*" name="pass" style="color:#e92c2b;background-color:#ffe299;height:30px;width:30%;font-size:15px;"required/>
&nbsp&nbsp&nbsp&nbsp
